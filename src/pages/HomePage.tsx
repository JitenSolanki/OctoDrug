    ...
    <div className="flex flex-col min-h-screen">
      <section className="bg-gradient-to-r from-indigo-700 to-purple-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/draw" className="inline-flex items-center justify-center px-6 py-3 text-indigo-700 bg-white hover:bg-gray-100 rounded-md">
              <PenTool className="mr-2 h-5 w-5" /> Draw Molecule
            </Link>
            <Link to="/database" className="inline-flex items-center justify-center px-6 py-3 text-white bg-indigo-600 hover:bg-indigo-500 rounded-md">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-xl text-gray-600">{backendMessage}</p>
        </div>
      </section>
    </div>
  );
